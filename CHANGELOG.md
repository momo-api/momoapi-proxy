...
- Send local/data-URL references directly in APIMart `image_urls`; the MOMO gateway has no `/v1/uploads/images` route. Forward validated public HTTPS references without downloading them.
