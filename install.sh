...
rm -rf "$INSTALL_DIR"
  ...
  URLS=(
    "https://github.com/momo-api/momoapi-proxy/releases/download/v0.9.7/momoapi-proxy-0.9.7.tgz"
    "https://ghproxy.net/https://github.com/momo-api/momoapi-proxy/releases/download/v0.9.7/momoapi-proxy-0.9.7.tgz"
