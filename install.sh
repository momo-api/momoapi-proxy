...
rm -rf "$INSTALL_DIR"
  ...
  URLS=(
    "https://github.com/momo-api/momoapi-proxy/releases/download/v0.10.3/momoapi-proxy-0.10.3.tgz"
    "https://ghproxy.net/https://github.com/momo-api/momoapi-proxy/releases/download/v0.10.3/momoapi-proxy-0.10.3.tgz"
