...
if (Test-Path $installDir) {
  ...
  $urls = @(
    ...
    "$Endpoint/install/packages/momo-api-codex-bridge-0.7.0.tgz",
    "https://momoapi.us/install/packages/momo-api-codex-bridge-latest.tgz",
    "https://github.com/momo-api/momo-codex-bridge/releases/download/v0.7.0/momo-api-codex-bridge-0.7.0.tgz",
    "https://ghproxy.net/https://github.com/momo-api/momo-codex-bridge/releases/download/v0.7.0/momo-api-codex-bridge-0.7.0.tgz"
  )
